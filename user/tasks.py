...
from dairy.models import Order,  DistributorOrder
...
def generate_customer_bill(target_month, target_year,users=None):
...
def generate_distributor_bill(target_month, target_year,users=None):
