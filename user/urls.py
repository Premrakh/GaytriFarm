...
from .views import (UserRegistrationView, UserLoginView, EmailVerificationView, UserRoleView,
                    ...
                    AddPayment, CustomerBalanceView, DistributorBalanceView , BankAccountView,UserBillView,GenerateBillView,UserStatusView,UpdateCustomerDistributor,
                    UpdateUserView,CreateAdminView
                    )
urlpatterns = [
    ...
    path('update_customer_distributor/', UpdateCustomerDistributor.as_view()),
